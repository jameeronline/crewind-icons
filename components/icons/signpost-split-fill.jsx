...
const SvgSignpostSplitFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="signpost-split-fill_svg__bi signpost-split-fill_svg__bi-signpost-split-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSignpostSplitFill;
