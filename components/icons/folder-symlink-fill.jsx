...
const SvgFolderSymlinkFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="folder-symlink-fill_svg__bi folder-symlink-fill_svg__bi-folder-symlink-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgFolderSymlinkFill;
