...
const SvgCameraVideoOffFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="camera-video-off-fill_svg__bi camera-video-off-fill_svg__bi-camera-video-off-fill"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgCameraVideoOffFill;
