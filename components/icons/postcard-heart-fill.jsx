...
const SvgPostcardHeartFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="postcard-heart-fill_svg__bi postcard-heart-fill_svg__bi-postcard-heart-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgPostcardHeartFill;
