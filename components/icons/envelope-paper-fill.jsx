...
const SvgEnvelopePaperFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="envelope-paper-fill_svg__bi envelope-paper-fill_svg__bi-envelope-paper-fill"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgEnvelopePaperFill;
