...
const SvgEnvelopeSlashFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="envelope-slash-fill_svg__bi envelope-slash-fill_svg__bi-envelope-slash-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgEnvelopeSlashFill;
