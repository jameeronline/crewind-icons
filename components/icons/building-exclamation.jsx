...
const SvgBuildingExclamation = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="building-exclamation_svg__bi building-exclamation_svg__bi-building-exclamation"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgBuildingExclamation;
