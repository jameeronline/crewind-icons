...
const SvgSignMergeLeftFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="sign-merge-left-fill_svg__bi sign-merge-left-fill_svg__bi-sign-merge-left-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSignMergeLeftFill;
