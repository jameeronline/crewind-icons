...
const SvgArrowsCollapseVertical = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="arrows-collapse-vertical_svg__bi arrows-collapse-vertical_svg__bi-arrows-collapse-vertical"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgArrowsCollapseVertical;
