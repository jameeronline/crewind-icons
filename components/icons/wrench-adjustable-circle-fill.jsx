...
const SvgWrenchAdjustableCircleFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="wrench-adjustable-circle-fill_svg__bi wrench-adjustable-circle-fill_svg__bi-wrench-adjustable-circle-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgWrenchAdjustableCircleFill;
