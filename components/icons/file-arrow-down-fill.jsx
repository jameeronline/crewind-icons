...
const SvgFileArrowDownFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="file-arrow-down-fill_svg__bi file-arrow-down-fill_svg__bi-file-arrow-down-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgFileArrowDownFill;
