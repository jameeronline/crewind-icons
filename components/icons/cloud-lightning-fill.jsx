...
const SvgCloudLightningFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="cloud-lightning-fill_svg__bi cloud-lightning-fill_svg__bi-cloud-lightning-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgCloudLightningFill;
