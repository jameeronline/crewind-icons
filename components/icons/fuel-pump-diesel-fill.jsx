...
const SvgFuelPumpDieselFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="fuel-pump-diesel-fill_svg__bi fuel-pump-diesel-fill_svg__bi-fuel-pump-diesel-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgFuelPumpDieselFill;
