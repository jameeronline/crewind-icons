...
const SvgEmojiHeartEyesFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="emoji-heart-eyes-fill_svg__bi emoji-heart-eyes-fill_svg__bi-emoji-heart-eyes-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgEmojiHeartEyesFill;
