...
const SvgSkipBackwardCircle = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="skip-backward-circle_svg__bi skip-backward-circle_svg__bi-skip-backward-circle"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSkipBackwardCircle;
