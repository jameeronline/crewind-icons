...
const SvgLayoutSidebarInsetReverse = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="layout-sidebar-inset-reverse_svg__bi layout-sidebar-inset-reverse_svg__bi-layout-sidebar-inset-reverse"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgLayoutSidebarInsetReverse;
