...
const SvgPatchExclamationFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="patch-exclamation-fill_svg__bi patch-exclamation-fill_svg__bi-patch-exclamation-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgPatchExclamationFill;
