...
const SvgEmojiSmileUpsideDownFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="emoji-smile-upside-down-fill_svg__bi emoji-smile-upside-down-fill_svg__bi-emoji-smile-upside-down-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgEmojiSmileUpsideDownFill;
