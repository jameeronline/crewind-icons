...
const SvgTrainFreightFront = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="train-freight-front_svg__bi train-freight-front_svg__bi-train-freight-front"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgTrainFreightFront;
