...
const SvgCalendar2PlusFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="calendar2-plus-fill_svg__bi calendar2-plus-fill_svg__bi-calendar2-plus-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgCalendar2PlusFill;
