...
const SvgTicketDetailedFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="ticket-detailed-fill_svg__bi ticket-detailed-fill_svg__bi-ticket-detailed-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgTicketDetailedFill;
