...
const SvgSignNoParkingFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="sign-no-parking-fill_svg__bi sign-no-parking-fill_svg__bi-sign-no-parking-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSignNoParkingFill;
