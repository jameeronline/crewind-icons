...
const SvgSymmetryHorizontal = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="symmetry-horizontal_svg__bi symmetry-horizontal_svg__bi-symmetry-horizontal"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSymmetryHorizontal;
