...
const SvgFileEarmarkXFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="file-earmark-x-fill_svg__bi file-earmark-x-fill_svg__bi-file-earmark-x-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgFileEarmarkXFill;
