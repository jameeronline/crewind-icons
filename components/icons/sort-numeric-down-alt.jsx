...
const SvgSortNumericDownAlt = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="sort-numeric-down-alt_svg__bi sort-numeric-down-alt_svg__bi-sort-numeric-down-alt"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgSortNumericDownAlt;
