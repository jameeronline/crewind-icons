...
const SvgArrowDownRightSquareFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="arrow-down-right-square-fill_svg__bi arrow-down-right-square-fill_svg__bi-arrow-down-right-square-fill"
    viewBox="0 0 16 16"
    {...props}
  >
