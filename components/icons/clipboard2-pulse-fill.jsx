...
const SvgClipboard2PulseFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="clipboard2-pulse-fill_svg__bi clipboard2-pulse-fill_svg__bi-clipboard2-pulse-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgClipboard2PulseFill;
