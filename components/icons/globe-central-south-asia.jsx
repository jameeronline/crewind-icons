...
const SvgGlobeCentralSouthAsia = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="globe-central-south-asia_svg__bi globe-central-south-asia_svg__bi-globe-central-south-asia"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgGlobeCentralSouthAsia;
