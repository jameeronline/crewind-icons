...
const SvgTelephoneMinusFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="telephone-minus-fill_svg__bi telephone-minus-fill_svg__bi-telephone-minus-fill"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgTelephoneMinusFill;
