...
const SvgBookmarkCheckFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="bookmark-check-fill_svg__bi bookmark-check-fill_svg__bi-bookmark-check-fill"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgBookmarkCheckFill;
