...
const SvgBrightnessLowFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="brightness-low-fill_svg__bi brightness-low-fill_svg__bi-brightness-low-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgBrightnessLowFill;
