...
const SvgSkipForwardCircleFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="skip-forward-circle-fill_svg__bi skip-forward-circle-fill_svg__bi-skip-forward-circle-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSkipForwardCircleFill;
