...
const SvgSignTurnRightFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="sign-turn-right-fill_svg__bi sign-turn-right-fill_svg__bi-sign-turn-right-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSignTurnRightFill;
