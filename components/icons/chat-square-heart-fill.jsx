...
const SvgChatSquareHeartFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="chat-square-heart-fill_svg__bi chat-square-heart-fill_svg__bi-chat-square-heart-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgChatSquareHeartFill;
