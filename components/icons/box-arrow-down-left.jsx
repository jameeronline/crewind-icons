...
const SvgBoxArrowDownLeft = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="box-arrow-down-left_svg__bi box-arrow-down-left_svg__bi-box-arrow-down-left"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgBoxArrowDownLeft;
