...
const SvgBrightnessAltHigh = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="brightness-alt-high_svg__bi brightness-alt-high_svg__bi-brightness-alt-high"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgBrightnessAltHigh;
