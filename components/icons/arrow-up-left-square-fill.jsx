...
const SvgArrowUpLeftSquareFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="arrow-up-left-square-fill_svg__bi arrow-up-left-square-fill_svg__bi-arrow-up-left-square-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgArrowUpLeftSquareFill;
