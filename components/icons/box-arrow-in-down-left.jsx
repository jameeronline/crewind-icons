...
const SvgBoxArrowInDownLeft = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="box-arrow-in-down-left_svg__bi box-arrow-in-down-left_svg__bi-box-arrow-in-down-left"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgBoxArrowInDownLeft;
