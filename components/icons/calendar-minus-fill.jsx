...
const SvgCalendarMinusFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="calendar-minus-fill_svg__bi calendar-minus-fill_svg__bi-calendar-minus-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgCalendarMinusFill;
