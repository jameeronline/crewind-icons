...
const SvgArrowsExpandVertical = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="arrows-expand-vertical_svg__bi arrows-expand-vertical_svg__bi-arrows-expand-vertical"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgArrowsExpandVertical;
