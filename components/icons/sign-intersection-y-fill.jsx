...
const SvgSignIntersectionYFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="sign-intersection-y-fill_svg__bi sign-intersection-y-fill_svg__bi-sign-intersection-y-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSignIntersectionYFill;
