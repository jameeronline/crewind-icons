...
const SvgChevronBarContract = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="chevron-bar-contract_svg__bi chevron-bar-contract_svg__bi-chevron-bar-contract"
    viewBox="0 0 16 16"
    {...props}
  >
    <path
...
export default SvgChevronBarContract;
