...
const SvgChatLeftHeartFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="chat-left-heart-fill_svg__bi chat-left-heart-fill_svg__bi-chat-left-heart-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgChatLeftHeartFill;
