...
const SvgCalendar2RangeFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="calendar2-range-fill_svg__bi calendar2-range-fill_svg__bi-calendar2-range-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgCalendar2RangeFill;
