...
const SvgFileEarmarkBinaryFill = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="file-earmark-binary-fill_svg__bi file-earmark-binary-fill_svg__bi-file-earmark-binary-fill"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgFileEarmarkBinaryFill;
