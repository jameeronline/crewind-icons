...
const SvgSignIntersectionT = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    fill="currentColor"
    className="sign-intersection-t_svg__bi sign-intersection-t_svg__bi-sign-intersection-t"
    viewBox="0 0 16 16"
    {...props}
  >
...
export default SvgSignIntersectionT;
